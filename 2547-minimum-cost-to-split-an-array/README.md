<h2><a href="https://leetcode.com/problems/minimum-cost-to-split-an-array/description/">2633. Minimum Cost to Split an Array</a></h2><h3>Hard</h3><hr><p>You are given an integer array <code>nums</code> and an integer <code>k</code>.</p>
